...
---@see source https://github.com/sitiom/nvim-numbertoggle
---@license https://github.com/sitiom/nvim-numbertoggle/blob/main/LICENSE
local num_toggle_augroup = augroup('numbertoggle')
vim.api.nvim_create_autocmd({ 'BufEnter', 'FocusGained', 'InsertLeave', 'CmdlineLeave', 'WinEnter' }, {
  pattern = '*',
  group = num_toggle_augroup,
  callback = function()
