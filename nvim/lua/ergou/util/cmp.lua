...
function M.cmp_sort()
  ...
  local modified_priority = {
    ...
    [types.lsp.CompletionItemKind.Struct] = 3,
    [types.lsp.CompletionItemKind.Keyword] = 4,
    [types.lsp.CompletionItemKind.Method] = 5,
    [types.lsp.CompletionItemKind.Function] = 6,
    [types.lsp.CompletionItemKind.Constructor] = 7,
    [types.lsp.CompletionItemKind.Variable] = 8,
    [types.lsp.CompletionItemKind.Class] = 9,
    [types.lsp.CompletionItemKind.Interface] = 10,
    [types.lsp.CompletionItemKind.Module] = 11,
    [types.lsp.CompletionItemKind.Unit] = 12,
    [types.lsp.CompletionItemKind.Value] = 13,
    [types.lsp.CompletionItemKind.Enum] = 14,
